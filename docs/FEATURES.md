...
| E21b | Sửa dở chữ gốc rồi bấm sang vùng khác không còn mất im lặng (hỏi Lưu / Bỏ / Ở lại); thêm nút Trước-Sau và bộ lọc theo trạng thái rà soát; sửa chữ gốc không còn kéo theo một lượt căn chữ vô ích | **BUILT** (audit bác bỏ 2/3 đề bài vì đã có sẵn từ E12 — xem `REPORT_E21b.md`; backend 1193 passed/6 skipped/0 failed + frontend 331 xanh; kiểm bằng Chromium thật trên stack local, **chưa deploy** vì có đổi hợp đồng API) |
